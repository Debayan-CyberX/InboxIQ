            ...
            >
              ...
              <div className="relative flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0 space-y-2">
                  ...
                  <p className="text-sm sm:text-base text-foreground/95 line-clamp-1 truncate font-semibold">
                    {action.subject}
                  </p>

                  <p className="text-xs sm:text-sm text-muted-foreground/90 flex items-center gap-2">
                    <Clock className="w-4 h-4 shrink-0 text-accent/60" />
